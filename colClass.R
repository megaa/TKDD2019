...
#'@export
impColClass <- function(name = c("training1st", "training2nd", "training3rd", "testing2nd", "testing3rd")) {
  impclass <- c(
    BidID = "character",
    Timestamp = "character",
    LogType = "integer",
  ...
  switch(name[1],
         ...
         "testing2nd"  = c(impclass, adid = "character", usertag = "character", R_CLK = "integer", R_CONV = "integer"), 
	 "testing3rd"  = c(impclass, adid = "character", usertag = "character", R_CLK = "integer", R_CONV = "integer"),
         stop("Invalid name")
  )
}
